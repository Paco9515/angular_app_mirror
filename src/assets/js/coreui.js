    ...
    */
      ...
      function () {
        ...
        _proto.loadPage = function loadPage(url) {
			...
			var loadScripts = function loadScripts(src, element) {
				...
				var body = document.getElementById('menu')[0];
    ...
    var removeClasses = function removeClasses(classNames) {
      return classNames.map(function (className) {
        return document.getElementById('menu').classList.contains(className);
      }).indexOf(true) !== -1;
    };
    ...
    var toggleClasses = function toggleClasses(toggleClass, classNames) {
      ...
      if (removeClasses(newClassNames)) {
        newClassNames.map(function (className) {
          return document.getElementById('menu').classList.remove(className);
        });
      } else {
        document.getElementById('menu').classList.add(toggleClass);
      }
    };
      ...
      function () {
        ...
        _proto.perfectScrollbar = function perfectScrollbar(event) {
          ...
          if (typeof PerfectScrollbar !== 'undefined') {
            var classList = document.getElementById('menu').classList;
        ...
        _proto._clickOutListener = function _clickOutListener(event) {
          if (!this._element.contains(event.target)) {
            ...
            document.getElementById('menu').classList.remove('sidebar-show');
          }
        };
        ...
        _proto._toggleClickOut = function _toggleClickOut() {
          if (this.mobile && document.getElementById('menu').classList.contains('sidebar-show')) {
            document.getElementById('menu').classList.remove('aside-menu-show');
